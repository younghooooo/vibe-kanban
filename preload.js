...
contextBridge.exposeInMainWorld('api', {
  ...
  docPath:  (cardId, cwd)          => ipcRenderer.invoke('doc:path', { cardId, cwd }),
  docWrite: (cardId, cwd, content) => ipcRenderer.invoke('doc:write', { cardId, cwd, content }),
  docRead:  (cardId, cwd)          => ipcRenderer.invoke('doc:read', { cardId, cwd }),
